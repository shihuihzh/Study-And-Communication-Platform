  ...
  <footer id="footer">
    <div class="container">
      ...
      <dl class="col-sm-2 site-link">
        ...
        <dd>
          <a href="${basePath}tos">服务条款</a>
        </dd>
        <dd>
          <a href="${basePath}faq">帮助中心</a>
        </dd>
        <dd>
          <a href="${basePath}q/1010000000187808">编辑器语法</a>
        </dd>
      </dl>
      <dl class="col-sm-2 site-link">
        <dt>联系合作</dt>
        <dd>
          <a href="${basePath}link">合作伙伴</a>
        </dd>
        <dd>
          <a href="${basePath}press">媒体报道</a>
        </dd>
        <dd>
          <a href="http://0x.segmentfault.com">建议反馈</a>
        </dd>
      </dl>
      <dl class="col-sm-2 site-link">
        <dt>常用链接</dt>
        <dd>
          <a href="http://blog.segmentfault.com/devblog" target="_blank">开发日志</a>
        </dd>
        <dd>
          <a href="${basePath}mobileapp">移动应用</a>
        </dd>
        <dd>
          <a href="${basePath}events?category=3">黑客马拉松</a>
        </dd>
        <dd>
          <a href="http://yumiwan.com" target="_blank">玉米湾域名</a>
        </dd>
      </dl>
      <dl class="col-sm-2 site-link">
        <dt>关注我们</dt>
        <dd>
          <a href="${basePath}feeds">问答 RSS 订阅</a>
        </dd>
        <dd>
          <a href="http://weibo.com/segmentfault" target="_blank">新浪微博</a>
        </dd>
        <dd>
          <a href="http://twitter.com/segment_fault" target="_blank">Twitter</a>
        </dd>
        <dd>
          <a href="http://t.qq.com/segmentfault" target="_blank">腾讯微博</a>
        </dd>
        <dd>
          <a href="http://page.renren.com/699146294" target="_blank">人人网</a>
        </dd>
      </dl>
      <dl class="col-sm-4 site-link" id="license">
        ...
        <dd>
          除特别说明外，用户内容均采用
          <a rel="license" target="_blank" href="http://creativecommons.org/licenses/by-sa/3.0/cn/">知识共享署名-相同方式共享 3.0 中国大陆许可协议</a>
          进行许可
        </dd>
        <dd>
          本站由
          <a target="_blank" href="http://elinkhost.com/">Elinkhost</a>
          提供 IDC 服务
          <br>
          <a target="_blank" href="https://www.upyun.com/?utm_source=segmentfault&amp;utm_medium=link&amp;utm_campaign=upyun&amp;md=segmentfault">又拍云</a>
          提供 CDN 存储服务
        </dd>
      </dl>
    </div>
